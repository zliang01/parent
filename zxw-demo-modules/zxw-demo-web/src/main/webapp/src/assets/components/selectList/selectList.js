...
define('text!components/selectList/selectList.tpl',[],function () { return '<label>{{{label}}}</label>\r\n<div>\r\n    <input type="text" class="texts" name="sn-{{name}}-text"/>\r\n    <input type="hidden" class="values" name="{{name}}" />\r\n</div>\r\n';});
 ...
 */
define('selectList',['hdb',
    'eventTarget',
    'text!components/selectList/selectList.tpl', 'artDialog'], 
