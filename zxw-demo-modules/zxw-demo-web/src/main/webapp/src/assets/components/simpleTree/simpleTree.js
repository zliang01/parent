...
define("zTree", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$.fn.zTree;
    };
}(this)));
