...
// require(['js/index/index'],function(IndexClass){
...
20160815后可以删除
//url.endsWith('.tpl')
// 'jquery.multipleSelect': { deps: ['jquery'] },
...
从requirejsMain中移除的插件


// "jquery.fileupload-ui": "assets/lib/jqueryPlugin/jQuery-File-Upload/js/jquery.fileupload-ui",
        // "jquery.fileupload-process": "assets/lib/jqueryPlugin/jQuery-File-Upload/js/jquery.fileupload-process",
        // "jquery.fileupload-image": "assets/lib/jqueryPlugin/jQuery-File-Upload/js/jquery.fileupload-image",
        // "jquery.fileupload-audio": "assets/lib/jqueryPlugin/jQuery-File-Upload/js/jquery.fileupload-audio",
        // "jquery.fileupload-video": "assets/lib/jqueryPlugin/jQuery-File-Upload/js/jquery.fileupload-video",
        // "jquery.fileupload-validate": "assets/lib/jqueryPlugin/jQuery-File-Upload/js/jquery.fileupload-validate",

        // 'jquery.fileupload-process': { deps: ['jquery'] },
        // 'jquery.fileupload-image': { deps: ['jquery'] },
        // 'jquery.fileupload-audio': { deps: ['jquery'] },
        // 'jquery.fileupload-video': { deps: ['jquery'] },
        // 'jquery.fileupload-validate': { deps: ['jquery'] },
        // 'jquery.fileupload-ui': { deps: ['jquery'] },
